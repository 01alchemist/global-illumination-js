 ...
 */
export class Avent extends CanvasDisplay {
    ...
    onInit() {
        ...
        var camera:Camera = Camera.lookAt(new Vector3(-2, 2, 5), new Vector3(0, 0, 0), new Vector3(0, 1, 0), 45);

        loader.load("Avent.obj", function (_mesh) {
            if (!_mesh) {
